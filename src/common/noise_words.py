# Desc: List of words to ignore when processing text; evething in this list must be lowercase
noise_words = [
    'i', 'i,', 'me', 'my', 'myself', 'we', 'our', 'ours', 'ourselves', 'you,', 'you', "you're", "you've", "you'll", "you'd", 'your', 'yours', 'yourself', 'yourselves',
    ...
    'won', "won't", 'wouldn', "wouldn't", "umm", "umm,", "umm.", "umm...", "umm..", "umm....","um, ", "um,", "um.", "um...", "um..", "too.", "too,", "too..", "too...", "too",
    "okay", "okay,", "okay.", "okay...", "okay..", "okay....", "ok", "ok,", "ok.", "ok...", "ok..", "ok....", "ok?", "ok?,", "ok?.", "ok?...", "ok?..", "ok?....", "ok!",
